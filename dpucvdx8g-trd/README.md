...
After Linux booting on board, firstly install the [Vitis AI Runtime for VCK90](https://github.com/Xilinx/Vitis-AI/tree/master/board_setup/vck190) .
...
```
###### **Note:** For running other networks, refer to the [Vitis AI Github](https://github.com/Xilinx/Vitis-AI) and 'Vitis AI User Guide'.
